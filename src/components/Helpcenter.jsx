...
export default function HelpCenter() {
    ...
    return (
        <div className="h-screen bg-gradient-to-br flex items-start justify-center" style={{ height: "calc(100vh - 140px)" }}>
            <main className=" rounded-lg max-w-4xl w-full p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        <h3 className="text-2xl font-semibold mb-4">Write your query to us</h3>
                        {isSubmitted && (
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <button
                                type="submit"
                                className="w-full bg-cyan-600 text-white py-3 px-4 rounded-md hover:bg-cyan-700 transition duration-200 ease-in-out transform hover:scale-105 flex items-center justify-center shadow-lg"
                            >
